/******************************************************
	会員管理テーブル(mla_member_tbl)
		...
		更新日
******************************************************/
DROP TABLE IF EXISTS spring_database.mla_member_tbl;
CREATE TABLE spring_database.mla_member_tbl
(
...
INSERT INTO spring_database.mla_member_tbl VALUES
...
/******************************************************
	プランマスタ(mla_plan_mst)
		...
		更新日
******************************************************/
DROP TABLE IF EXISTS spring_database.mla_plan_mst;
CREATE TABLE spring_database.mla_plan_mst
(
    plan_id          INT NOT NULL,
...
INSERT INTO spring_database.mla_plan_mst VALUES
...
/******************************************************
	支払マスタ(mla_pay_mst)
		...
		更新日
******************************************************/
DROP TABLE IF EXISTS spring_database.mla_pay_mst;
CREATE TABLE spring_database.mla_pay_mst
(
    pay_id          INT NOT NULL,
...
INSERT INTO spring_database.mla_pay_mst VALUES
	(0, 'Visa', NOW(), NOW()),
	(1, 'Master', NOW(), NOW()),
	(2, 'JCB', NOW(), NOW()),
	(3, '楽天', NOW(), NOW());
...
/******************************************************
	商品管理テーブル(mla_item_tbl)
		...
		更新日
******************************************************/
DROP TABLE IF EXISTS spring_database.mla_item_tbl;
CREATE TABLE spring_database.mla_item_tbl
(
...
INSERT INTO spring_database.mla_item_tbl VALUES
...
/******************************************************
	媒体マスタ(mla_media_mst)
		...
		更新日
******************************************************/
DROP TABLE IF EXISTS spring_database.mla_media_mst;
CREATE TABLE spring_database.mla_media_mst
(
    media_id           INT NOT NULL,
...
INSERT INTO spring_database.mla_media_mst VALUES
...
/******************************************************
	レンタル管理テーブル(mla_rental_tbl)
		...
		更新日
******************************************************/
DROP TABLE IF EXISTS spring_database.mla_rental_tbl;
CREATE TABLE spring_database.mla_rental_tbl
(
...
INSERT INTO spring_database.mla_rental_tbl VALUES
...
/******************************************************
	発送管理テーブル(mla_send_tbl)
		...
		更新日
******************************************************/
DROP TABLE IF EXISTS spring_database.mla_send_tbl;
CREATE TABLE spring_database.mla_send_tbl
(
    ...
    make_date        DATE,
    update_date      DATE,
    CONSTRAINT PRIMARY KEY (send_id)
);
INSERT INTO spring_database.mla_send_tbl VALUES
...
/******************************************************
	履歴テーブル(mla_history_tbl)
		...
		更新日
******************************************************/
DROP TABLE IF EXISTS spring_database.mla_history_tbl;
CREATE TABLE spring_database.mla_history_tbl
(
...
INSERT INTO spring_database.mla_history_tbl VALUES
	(1, 1, 0, NOW(), NOW());
